...
export const StableDiffusionAPIApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        apiV3Fetch5264Post: async (body?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v3/fetch/5264`;
...
export const StableDiffusionAPIApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV3Fetch5264Post(body?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await StableDiffusionAPIApiAxiosParamCreator(configuration).apiV3Fetch5264Post(body, options);
...
export const StableDiffusionAPIApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV3Fetch5264Post(body?: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return StableDiffusionAPIApiFp(configuration).apiV3Fetch5264Post(body, options).then((request) => request(axios, basePath));
        },
        /**
         * Generate images using Stable diffusion
         * @summary Image 2 Image
...
export class StableDiffusionAPI extends BaseAPI {
     ...
     */
    public async apiV3Fetch5264Post(body?: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return StableDiffusionAPIApiFp(this.configuration).apiV3Fetch5264Post(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Generate images using Stable diffusion
     * @summary Image 2 Image
